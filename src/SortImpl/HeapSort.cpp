...
void criaHeap (unsigned long int*, int, int, int (*orderby) (unsigned long int,unsigned long  int));

//Ordenacao que simula uma arvore binaria completa
void HeapSort (unsigned long int vet[], int inicio, int fim, int (*orderby) (unsigned long int,unsigned long  int)){ //inicio da funcao HeapSort
	int i, aux;
...
void criaHeap (unsigned long int vetor[], int inicio, int fim, int (*orderby) (unsigned long int, unsigned long int)){ //inicio da funcao criaHeap
